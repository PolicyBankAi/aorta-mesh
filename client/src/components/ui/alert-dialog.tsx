...
/**
 * AlertDialog (AORTA Mesh Hardened)
 * ---------------------------------
 * - Cyan/black theme
 * - Accessible (aria, role)
 * - Stronger testability
 * - Styled for critical actions (approve/reject, revoke access)
 */
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-cyan-400", className)}
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    className={cn(
      ...
      "bg-green-600 hover:bg-green-700 text-white border border-cyan-400",
      className
    )}
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "text-cyan-300 border-cyan-400 hover:bg-gray-900",
      className
    )}
