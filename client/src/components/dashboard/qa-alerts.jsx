...
export default function QaAlerts() {
    const { data: alerts, isLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            if (!response.ok)
                throw new Error('Failed to fetch QA alerts');
    ...
    if (isLoading) {
        return (<Card className="bg-black border-cyan-400 shadow rounded-lg" data-testid="qa-alerts-loading">
    ...
    return (<Card className="bg-black border-cyan-400 shadow rounded-lg h-full" data-testid="qa-workbench">
      <CardHeader className="border-b border-cyan-400">
