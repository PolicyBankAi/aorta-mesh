...
export default function RecentActivity() {
    ...
    if (isLoading) {
        return (<Card className="bg-black border-cyan-400 shadow rounded-lg" data-testid="recent-activity-loading">
        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            {Array.from({ length: 4 }).map((_, i) => (<div key={i} className="flex space-x-3">
    ...
    return (<Card className="bg-black border-cyan-400 shadow rounded-lg h-full" data-testid="recent-activity">
      <CardHeader className="border-b border-cyan-400">
        <CardTitle className="text-cyan-400">Recent Activity</CardTitle>
        <p className="text-sm text-cyan-300">Latest updates across all case passports</p>
      </CardHeader>
