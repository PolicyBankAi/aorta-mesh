        ...
        <main className="flex-1 relative overflow-y-auto focus:outline-none bg-gray-900">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {queues.map((queue) => (<div key={queue.id} className={`bg-gray-800 border border-gray-700 rounded-lg p-4 cursor-pointer transition-colors ${selectedQueue === queue.id ? 'ring-2 ring-blue-500' : 'hover:border-gray-600'}`} onClick={() => setSelectedQueue(queue.id)}>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-700">
                  ...
                  <tbody className="bg-gray-800 divide-y divide-gray-700">
                    {queueItems.map((item) => (<tr key={item.id} className="hover:bg-gray-700">
