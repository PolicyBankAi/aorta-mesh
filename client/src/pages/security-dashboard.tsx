...
export default function SecurityDashboard() {
  ...
  const { data: complianceDashboard } = useQuery<ComplianceDashboard>({
                ...
                <CardContent>
                  <ScrollArea className="h-64">
                    <div className="space-y-2">
                      ...
                      complianceDashboard.recentEvidence.length > 0 ? (
                        complianceDashboard.recentEvidence.map((evidence, index) => (
                          <div
                            key={index}
