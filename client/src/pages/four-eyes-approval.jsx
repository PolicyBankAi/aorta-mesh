          ...
          <div className="p-6">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                {pendingApprovals.map((approval) => (<Card key={approval.id} className="bg-gray-800 border-gray-700">
                        ...
                        <div className="lg:col-span-2">
                          ...
                          <div className="mb-4">
                            ...
                            <div className="space-y-1">
                              {approval.documents.map((doc, index) => (<div key={index} className="flex items-center text-sm text-blue-400 hover:text-blue-300 cursor-pointer">
                ...
                width: `${(approval.currentApprovals / approval.requiredApprovers) * 100}%`
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              {approval.approvers.map((approver, index) => (<div key={index} className="flex items-center justify-between bg-gray-700 rounded p-2">
                                  <div>
                                    <p className="text-sm text-gray-300">{approver.name}</p>
                                    <p className="text-xs text-gray-400">{approver.role}</p>
                                  </div>
                                  <div>
                                    {approver.status === 'approved' ? (<CheckCircle className="h-4 w-4 text-green-400"/>) : (<Clock className="h-4 w-4 text-yellow-400"/>)}
                                  </div>
                                </div>))}
                            </div>
                          </div>
                          ...
                          {/* Action Buttons */}
                          <div className="space-y-2">
                            <Button onClick={() => handleApprove(approval.id)} className="w-full bg-green-600 hover:bg-green-700" size="sm">
                              <CheckCircle className="h-4 w-4 mr-2"/>
                              Approve
                            </Button>
                            <Button onClick={() => handleReject(approval.id)} variant="outline" className="w-full border-red-600 text-red-400 hover:bg-red-600 hover:text-white" size="sm">
                              <AlertTriangle className="h-4 w-4 mr-2"/>
                              Reject
                            </Button>
                            <Button variant="outline" className="w-full text-gray-300 border-gray-600" size="sm">
                              Request More Info
                            </Button>
                          </div>
                        </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-700">
                      ...
                      <tbody className="bg-gray-800 divide-y divide-gray-700">
                        {completedApprovals.map((approval) => (<tr key={approval.id}>
