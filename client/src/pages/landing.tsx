    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="border-b border-cyan-800 bg-black/90 backdrop-blur supports-[backdrop-filter]:bg-black/60">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={() => {
                window.location.href = "/login"; // ✅ redirect to production login page
              }}
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <Button
            onClick={() => {
              window.location.href = "/login"; // ✅ production login
            }}
            size="lg"
      ...
      <footer className="border-t border-cyan-800 bg-black py-8">
        <div className="container mx-auto px-4 text-center text-gray-400">
          <p>
            &copy; 2024 AORTA Mesh™. Enterprise-grade organ and tissue traceability platform.
          </p>
        </div>
      </footer>
    </div>
