...
import { Upload, Download, Share, Tag, Archive, RefreshCw, FileSpreadsheet } from "lucide-react";
...
export default function BulkOperations() {
    ...
    const handleStartBulkOperation = (operationType) => {
        toast({
                  ...
                  <Card className="bg-gray-800 border-gray-700">
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-3">
                        ...
                        <Button onClick={() => handleStartBulkOperation("Bulk Share")} className="w-full bg-blue-600 hover:bg-blue-700" size="sm">
                          Start Bulk Share
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-gray-800 border-gray-700">
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-3">
                        ...
                        <Button onClick={() => handleStartBulkOperation("Bulk Label")} className="w-full bg-green-600 hover:bg-green-700" size="sm">
                          Start Bulk Label
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-gray-800 border-gray-700">
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-3">
                        ...
                        <Button onClick={() => handleStartBulkOperation("Bulk Compile")} className="w-full bg-purple-600 hover:bg-purple-700" size="sm">
                          Start Bulk Compile
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <div>
                        ...
                        <div className="space-y-3">
                          {bulkTemplates.map((template) => (<div key={template.id} className="bg-gray-700 rounded-lg p-4">
                              ...
                              <div className="flex flex-wrap gap-1">
                                {template.fields.map((field, index) => (<Badge key={index} variant="outline" className="text-xs text-gray-300 border-gray-600">
                                    {field}
                                  </Badge>))}
                              </div>
                            </div>))}
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {activeJobs.map((job) => (<div key={job.id} className="bg-gray-700 rounded-lg p-4">
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-700">
                        ...
                        <tbody className="bg-gray-800 divide-y divide-gray-700">
                          {completedJobs.map((job) => (<tr key={job.id}>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                <div className="text-gray-300">
                                  ...
                                  {job.errorCount > 0 && (<span className="ml-2">
