...
export default function Landing() {
    return (<div className="min-h-screen bg-black text-white">
      ...
      <header className="border-b border-cyan-800 bg-black/90 backdrop-blur supports-[backdrop-filter]:bg-black/60">
        ...
        }} className="bg-cyan-600 hover:bg-cyan-700 text-white px-6 py-2" data-testid="button-login">
              Sign In
            </Button>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        }} size="lg" className="bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white px-8 py-3" data-testid="button-get-started">
            Get Started
          </Button>
        </div>
